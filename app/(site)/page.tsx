...
const Home = async () => {
  ...
  return (
    <Container className="">
      <div className="w-full flex items-center flex-col mx-auto px-6 my-6">
        <ResponsiveCarousel />
        <div className="w-full md:w-3/4 py-14">
          <p className=" text-xl">
            Kenya Coffee Events (KCE) is an event management organization
            registered in Nairobi, Kenya. KCE was originally founded in 2020 by
            the Specialty Coffee Association of Kenya.
          </p>
        </div>{" "}
