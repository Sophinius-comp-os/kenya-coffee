...
export function BlogGrid({ posts }: { posts: [PostTypes] }) {
    return (
        <Container className=''>
            <div className="grid gap-6 mx-auto mt-14 sm:mt-16 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
                <div className="lg:absolute hidden gap-6 -top-20 lg:-left-4 xl:flex 2xl:-left-24">
        <span
